...
public class TrampolineColliderObject : KnockablePlatformColliderObject
{
    ...
    public override void OnHitCollision(Collision collision)
    {
        if (collision.gameObject.CompareTag("Player"))
        {
            ...
            if (character != null)
            {
                character.OnHitTrampolineObstacle(false, rootTrampolineHitbox, safeSpotConfig, gameObject.name);
            }
        }
    }
